...
export type LaunchProfileQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'launch_success' | 'details' | 'mission_name' | 'launch_year' | 'upcoming'>
    & { links?: Maybe<(
      { __typename?: 'LaunchLinks' }
      & Pick<LaunchLinks, 'article_link' | 'video_link' | 'wikipedia'>
    )> }
  )> }
);

export type RocketLaunchesQueryVariables = Exact<{ [key: string]: never; }>;


export type RocketLaunchesQuery = (
  { __typename?: 'Query' }
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'launch_success' | 'launch_year' | 'details'>
  )>>> }
);
...
export const RocketLaunchesDocument = gql`
...
/**
 * __useRocketLaunchesQuery__
 *
 * To run a query within a React component, call `useRocketLaunchesQuery` and pass it any options that fit your needs.
 * When your component renders, `useRocketLaunchesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useRocketLaunchesQuery({
 *   variables: {
 *   },
 * });
 */
export function useRocketLaunchesQuery(baseOptions?: Apollo.QueryHookOptions<RocketLaunchesQuery, RocketLaunchesQueryVariables>) {
        return Apollo.useQuery<RocketLaunchesQuery, RocketLaunchesQueryVariables>(RocketLaunchesDocument, baseOptions);
      }
export function useRocketLaunchesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<RocketLaunchesQuery, RocketLaunchesQueryVariables>) {
          return Apollo.useLazyQuery<RocketLaunchesQuery, RocketLaunchesQueryVariables>(RocketLaunchesDocument, baseOptions);
        }
export type RocketLaunchesQueryHookResult = ReturnType<typeof useRocketLaunchesQuery>;
export type RocketLaunchesLazyQueryHookResult = ReturnType<typeof useRocketLaunchesLazyQuery>;
export type RocketLaunchesQueryResult = Apollo.QueryResult<RocketLaunchesQuery, RocketLaunchesQueryVariables>;